...
export CC_PACKAGEID=a0d1830e14e18b522573fb8283e7c2491a4dc5fd473a2047c056bbf2edbd5493
...
peer lifecycle chaincode approveformyorg --tls --cafile $ORDERER_CA --channelID $CHANNEL_NAME --name $CHAINCODE_NAME --version $CHAINCODE_VERSION --sequence 1 --waitForEvent --signature-policy "OR ('Org1MSP.peer','Org3MSP.peer')" --package-id foodcontrol_1:830e14e18b522573fb8283e7c2491a4dc5fd473a2047c056bbf2edbd5493
